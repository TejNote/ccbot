...
# Korean descriptions for known skills (tg_command → description)
# Keys use the new format: plugin_skilldir (e.g. superpowers_brainstorming)
_SKILL_DESC_KO: dict[str, str] = {
    # superpowers
    "superpowers_brainstorming": "브레인스토밍 — 기능 설계 전 아이디어 구체화",
    "superpowers_writing_plans": "구현 계획 작성",
    "superpowers_executing_plans": "구현 계획 실행",
    "superpowers_systematic_debugging": "체계적 디버깅",
    "superpowers_test_driven_developmen": "TDD — 테스트 주도 개발",
    "superpowers_requesting_code_revie": "코드 리뷰 요청",
    "superpowers_receiving_code_review": "코드 리뷰 피드백 적용",
    "superpowers_dispatching_parallel_": "병렬 에이전트 분산",
    "superpowers_using_git_worktrees": "Git worktree 격리 작업",
    "superpowers_finishing_a_developme": "개발 브랜치 마무리",
    "superpowers_using_superpowers": "Superpowers 스킬 안내",
    "superpowers_verification_before_c": "완료 전 검증",
    "superpowers_writing_skills": "새 스킬 작성",
    "superpowers_subagent_driven_devel": "서브에이전트 기반 개발",
    # nestjs-hexagonal
    "nestjs_hexagonal_domain": "NestJS 도메인 레이어",
    "nestjs_hexagonal_application": "NestJS 애플리케이션 레이어",
    "nestjs_hexagonal_infrastructure": "NestJS 인프라 레이어",
    "nestjs_hexagonal_presentation": "NestJS 프레젠테이션 레이어",
    "nestjs_hexagonal_create_subdomai": "NestJS 바운디드 컨텍스트 생성",
    "nestjs_hexagonal_event_listeners": "NestJS 도메인 이벤트 리스너",
    "nestjs_hexagonal_review_subdomai": "NestJS 헥사고날 아키텍처 리뷰",
    "nestjs_hexagonal_using_nestjs_hex": "NestJS 헥사고날 라우터",
    "nestjs_hexagonal_websocket_broad": "WebSocket 브로드캐스팅",
    "nestjs_hexagonal_gsd_installer": "GSD 워크플로 설정",
    # figma
    "figma_figma_use": "Figma 파일 읽기 (필수 전처리)",
    "figma_figma_implement_design": "Figma → 코드 구현",
    "figma_figma_generate_design": "코드 → Figma 디자인 생성",
    "figma_figma_generate_library": "Figma 디자인 시스템 빌드",
    "figma_figma_code_connect": "Figma Code Connect 매핑",
    "figma_figma_create_new_file": "Figma 새 파일 생성",
    "figma_figma_create_design_system": "Figma 디자인 시스템 규칙 생성",
    # frontend-design
    "frontend_design_frontend_design": "프론트엔드 UI 디자인 구현",
    # octo
    "octo_skill_debug": "Octo 디버깅",
    "octo_skill_tdd": "Octo TDD",
    "octo_skill_code_review": "Octo 코드 리뷰",
    "octo_skill_prd": "Octo PRD 작성",
    "octo_skill_audit": "Octo 보안 감사",
    "octo_skill_deck": "Octo 슬라이드 덱 생성",
    "octo_skill_parallel_agents": "Octo 병렬 에이전트",
    "octo_octopus_quick": "Octo 빠른 실행",
    "octo_octopus_quick_review": "Octo 빠른 리뷰",
    "octo_octopus_architecture": "Octo 아키텍처 설계",
    "octo_octopus_security_audit": "Octo 보안 감사",
    "octo_flow_discover": "Octo 발견 단계",
    "octo_flow_define": "Octo 정의 단계",
    "octo_flow_develop": "Octo 개발 단계",
    "octo_flow_deliver": "Octo 배포 단계",
    "octo_flow_spec": "Octo 스펙 작성",
    "octo_skill_debate": "Octo AI 토론",
    # pr-review-toolkit
...
def _build_bot_commands() -> list[BotCommand]:
    ...
    if _skill_registry:
        # Telegram Bot API has undocumented ~5000 char total description limit.
        # Cap per-skill description to fit more skills within the budget.
        remaining = 100 - len(commands)
        desc_budget = 5000 - sum(len(c.description) for c in commands)
